...
function buildContractForContractMap(
  ...
  return {
    ...
    metadata: {
      ...
      metadataUri: "",
      audit: details.audit,
      publisher: "deployer.web3sdkio.eth",
    },
  };
}
...
export const BuiltinContractMap: Record<ContractType, BuiltinContractDetails> =
  {
    ...
    marketplace: buildContractForContractMap("marketplace", {
      ...
      audit: "ipfs://QmNgNaLwzgMxcx9r6qDvJmTFam6xxUxX7Vp8E99oRt7i74",
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/marketplace/Marketplace.sol",
      ecosytem: "evm",
    }),
    "edition-drop": buildContractForContractMap("edition-drop", {
      ...
      audit: "ipfs://QmWfueeKQrggrVQNjWkF4sYJECp56vNnuAXCPVecFFKz2j",
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/drop/DropERC1155.sol",
      ecosytem: "evm",
    }),
    multiwrap: buildContractForContractMap("multiwrap", {
      ...
      audit: "ipfs://QmWfueeKQrggrVQNjWkF4sYJECp56vNnuAXCPVecFFKz2j",
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/multiwrap/Multiwrap.sol",
      ecosytem: "evm",
    }),
    token: buildContractForContractMap("token", {
      ...
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/token/TokenERC20.sol",
      ecosytem: "evm",
    }),
    edition: buildContractForContractMap("edition", {
      ...
      audit: "ipfs://QmaMiezCMfmo5zWmwNc2WXLex11BuRZJ9p9ZhWj638Tdws",
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/token/TokenERC1155.sol",
      ecosytem: "evm",
    }),
    "token-drop": buildContractForContractMap("token-drop", {
      ...
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/drop/DropERC20.sol",
      ecosytem: "evm",
    }),
    ...
    "nft-collection": buildContractForContractMap("nft-collection", {
      ...
      audit: "ipfs://QmaMiezCMfmo5zWmwNc2WXLex11BuRZJ9p9ZhWj638Tdws",
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/token/TokenERC721.sol",
      ecosytem: "evm",
    }),
    ...
    pack: buildContractForContractMap("pack", {
      ...
      audit: "ipfs://QmfKqeUfUgNwFn5B1fUAxzikj89mneZEETKrF7JfaJg5St",
      sourceUrl:
        "https://raw.githubusercontent.com/web3sdkio/contracts/v3.1.3/contracts/pack/Pack.sol",
      ecosytem: "evm",
    }),

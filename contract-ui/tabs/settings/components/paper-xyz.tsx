...
import type { EditionDrop, NFTDrop } from "@web3sdkio/sdk/evm";
import {
  formatError,
  formatResponseData,
...
function createCodeSnippet(
  ...
  if (language === "javascript") {
    code = `
import { Web3sdkioSDK } from "@web3sdkio/sdk/evm";

async function createCheckoutIntent() {
  const sdk = new Web3sdkioSDK("${network}");

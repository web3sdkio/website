...
import { DelayedRevealLazyMintInput } from "@web3sdkio/react/evm";
import type { NFTMetadataInput } from "@web3sdkio/sdk";
              ...
              {(form.watch("revealType") || props.ecosystem === "solana") && (
                <>
                  ...
                  <Text size="body.sm" mt={2}>
                    <TrackedLink
                      href="https://web3sdkio.notion.site/Batch-Upload-Troubleshooting-dbfc0d3afa6e4d1b98b6199b449c1596"
                      isExternal

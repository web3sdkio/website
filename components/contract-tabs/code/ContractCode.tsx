...
const INSTALL_COMMANDS = {
  evm: {
    typescript: "npm install @web3sdkio/sdk ethers",
    javascript: "npm install @web3sdkio/sdk ethers",
    react: "npm install @web3sdkio/sdk @web3sdkio/react ethers",
    python: "pip install web3sdkio-sdk",
    go: "go get github.com/web3sdkio/go-sdk/web3sdkio",
  },
  solana: {
    typescript: "npm install @web3sdkio/sdk",
    javascript: "npm install @web3sdkio/sdk",
    react:
...
function useContractCodeSnippetQuery(ecosystem: "evm" | "solana") {
  return useQuery(["code-snippet"], async () => {
    ...
    const res = await fetch(
      `https://raw.githubusercontent.com/web3sdkio/docs/main/docs/${filename}.json`,
    );

...
const FAQs = [
  {
    ...
    answer:
      "A Solana faucet is a tool for developers to get free devnet Solana (SOL) tokens to test their applications before deploying them to mainnet. The web3sdkio Solana faucet is free, fast, and does not require authentication or login.",
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        or{" "}
        <Link href="https://twitter.com/web3sdkio" textDecor="underline">
          Twitter
        </Link>
        .
      </>

...
export const ReleasedContract: React.FC<ReleasedContractProps> = ({
  ...
  const twitterIntentUrl = useMemo(() => {
    ...
    url.searchParams.append(
      "text",
      `Check out this ${releaseName} contract on @web3sdkio
  ...
  return (
    <>
      <NextSeo
        ...
        description={`${release.description}${
          release.description ? ". " : ""
        }Deploy ${releaseName} in one click with web3sdkio.`}
        openGraph={{
          title,
          url: currentRoute,
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: `${releaseName} contract on web3sdkio`,
            },
          ],
        }}
      />
            ...
            <Flex gap={2} alignItems="center">
              <ShareButton
                ...
                text={`Deploy ${shortenIfAddress(
                  releaserEnsOrAddress,
                )}/${releaseName} in one click with web3sdkio.`}
              />
              <TrackedIconButton
                as={LinkButton}
                isExternal

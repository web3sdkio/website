...
import { Solana } from "@web3sdkio/chain-icons";
import { Web3sdkioSDKProvider, useSDK } from "@web3sdkio/react/solana";
          ...
          <Flex direction="column" gap={4}>
            <Flex direction="column">
              ...
              <Text size="body.md" fontStyle="italic">
                ...
                <TrackedLink
                  href="https://blog.web3sdk.io/guides/which-network-should-you-use"
                  color="primary.600"
                  category="deploy"

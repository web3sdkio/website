...
const steps = [
  {
    ...
    text: (
      <>
        ...
        <TrackedLink
          color="blue.500"
          href="https://portal.web3sdk.io/sdk"
          category={TRACK_CATEGORY}
          label="build-sdks"
          isExternal
        >
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <TrackedLink
          color="blue.500"
          href="https://portal.web3sdk.io/cli"
          category={TRACK_CATEGORY}
          label="launch-cli"
          isExternal
        >
        ...
        <TrackedLink
          color="blue.500"
          href="https://portal.web3sdk.io/dashboard"
          category={TRACK_CATEGORY}
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <TrackedLink
          color="blue.500"
          href="https://portal.web3sdk.io/dashboard/activity-feed"
          category={TRACK_CATEGORY}
        ...
        <TrackedLink
          color="blue.500"
          href="https://portal.web3sdk.io/dashboard/permission-controls"
          category={TRACK_CATEGORY}
          label="manage-dashboard"
          isExternal
        >
                          ...
                          <React.Fragment key={"step-0-t"}>
                            ...
                            <motion.div {...textAnimation}>
                              <Text size="body.lg" w="90%">
                                web3sdkio makes it easy to integrate web3

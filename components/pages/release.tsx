...
import { PREBUILT_CONTRACTS_MAP } from "@web3sdkio/sdk/evm";
...
import { WEB3SDKIO_DEPLOYER_ADDRESS } from "constants/addresses";
...
export const ReleaseWithVersionPage: React.FC<ReleaseWithVersionPageProps> = ({
  ...
  const prebuiltContractName =
    release?.releaser === WEB3SDKIO_DEPLOYER_ADDRESS

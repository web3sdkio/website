...
import Web3sdkioTeams from "public/assets/landingpage/web3sdkio-teams.png";
...
const HomePage: Web3sdkioNextPage = () => {
  const trackEvent = useTrack();

  const { onCopy, hasCopied } = useClipboard("npx web3sdkio@latest");
  return (
    <DarkMode>
      <Flex
        sx={{

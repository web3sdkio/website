...
const ExplorePage: Web3sdkioNextPage = (
  ...
  return (
    <>
      <NextSeo
        ...
        description="Browse a large collection of ready-to-deploy contracts that have been built by web3sdkio and other contract developers. Find a contract for your specific app's or game's needs."
        openGraph={{
          title: "web3sdkio Explore: Smart Contracts & Protocols",
          description:
            "Browse a large collection of ready-to-deploy contracts that have been built by web3sdkio and other contract developers. Find a contract for your specific app's or game's needs.",
          images: [
            {
              url: "https://web3sdk.io/web3sdkio-explore.png",
              width: 1200,
              height: 630,
              alt: "web3sdkio Explore",
            },
          ],
        }}
      />

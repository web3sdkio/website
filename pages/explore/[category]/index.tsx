...
const ExploreCategoryPage: Web3sdkioNextPage = (
  ...
  return (
    <>
      <NextSeo
        ...
        description={`${props.category.description} Deploy with one click to Ethereum, Polygon, Optimism, and other EVM blockchains with web3sdkio.`}
      />

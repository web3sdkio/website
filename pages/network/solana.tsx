...
const SOLANA_GUIDES = [
  {
    ...
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/10/This-is-the-one--12-.png",
  ...
  },
  {
    ...
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/09/Getting-started-with-solana-web3sdkio.png",
    link: "https://blog.web3sdk.io/guides/getting-started-with-solana/",
  },
  {
    title: "Why You Should Build on Solana: Pros and Cons",
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/09/This-is-the-one-5.png",
    link: "https://blog.web3sdk.io/guides/solana-development-pros-and-cons/",
  },
];

const Solana: Web3sdkioNextPage = () => {
  return (
    <ProductPage
      seo={{
        title: "Web3 Solana Smart Contracts, APIs, and Developer Tools",
        description:
          "Deploy Solana smart contracts, build web3 apps, and manage it all using our developer tools, SDKs, and more. Start building with web3sdkio now.",
        openGraph: {
          images: [
            {
              url: "https://web3sdk.io/web3sdkioxsolana.png",
              width: 1200,
              height: 630,
              alt: "web3sdkio x solana",
            },
          ],
        },
      }}
    >
        ...
        >
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap={6}>
            <DashboardCard
              ...
              rightImage={require("public/assets/landingpage/web3sdkio-teams.png")}
              gradientBGs={{
                topGradient: "#8752F3",
      ...
      <ProductSection>
        ...
        >
          ...
          <TrackedLink
            href="https://blog.web3sdk.io/tag/solana/"
            category="solana"
        ...
        >
          <Stack align="center" spacing={12}>
            <Heading
              ...
              textAlign="center"
            >
              Join the web3sdkio Solanathon on October 19th
            </Heading>
            <Stack
              spacing={5}

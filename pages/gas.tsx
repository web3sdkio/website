  ...
  return (
    <>
      <NextSeo
        ...
        description="Estimate the cost of gas fees when deploying contracts or performing common use cases to the blockchain on web3sdkio."
        openGraph={{
          title: "Blockchain Gas Estimator | web3sdkio",
          url: `https://web3sdk.io/gas`,
        }}
      />
      <Flex mb={4}>
        <Heading mr={3} as="h1">
      ...
      <Text mt={4} textAlign="center">
        ...
        deployed with web3sdkio. Updated every 60 seconds.
      </Text>
    </>
  );
};

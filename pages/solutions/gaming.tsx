...
const GAMING_GUIDES = [
  {
    ...
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/11/Group-625859--1-.png",
    link: "https://blog.web3sdk.io/guides/get-started-with-web3sdkios-unity-sdk/",
  },
  {
    title: "Add a Connect Wallet Button in a Unity Game",
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/12/This-is-the-one--33-.png",
  ...
  },
  {
    ...
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/12/Coinbase-Pay-guide.png",
...
const GAMING_CASE_STUDIES = [
  {
    ...
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/12/Chicago-Bulls.png",
    link: "https://blog.web3sdk.io/evolved-camels-builds-immersive-web3-gaming-experiences-for-their-community/",
  },
  {
    title: "Fractal, Web3 Gaming Platform and Marketplace for Blockchain Games",
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/11/Fractal.png",
    link: "https://blog.web3sdk.io/fractal-web3-gaming-platform-and-marketplace-for-blockchain-games-expands-to-evm-chains/",
  },
  {
    title:
      "Dreamworks Launches NFT Avatars for the Metaverse in Collaboration with Gala's VOX",
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/10/DreamWorks-Launches-NFT-Avatars-with-Gala-s-VOX---web3sdkio-Case-Study-2.png",
    link: "https://blog.web3sdk.io/dreamworks-launches-nft-avatars-for-web3-games-with-gala-and-the-sims-creators-voxverse/",
  },
];

const Gaming: Web3sdkioNextPage = () => {
  return (
    <ProductPage
      accentColor="rgba(22,82,240,.75)"
      seo={{
        title:
          "web3sdkio GamingKit | SDKs, Smart Contracts & Dev Tools for Web3 Games",
        description:
        ...
        openGraph: {
          images: [
            {
              url: `${getAbsoluteUrl()}/web3sdkioxcoinbase.png`,
              width: 1200,
              height: 630,
              alt: "web3sdkio x coinbase",
            },
          ],
        },
      }}
    >
      <Hero
        ...
        buttonLink="https://docs.web3sdk.io/gamingkit"
        ...
        secondaryButton={{
          text: "Request demo",
          link: "https://web3sdkio.typeform.com/tw-solutions",
        }}
      >
        <SimpleGrid
      ...
      <ProductSection py={{ base: 12, lg: 24 }}>
        <SDKSection
          ...
          codeSelectorProps={{
            ...
            docs: "https://docs.web3sdk.io/gamingkit",
          }}
        />
      </ProductSection>
      ...
      <ProductSection>
        ...
        >
          ...
          <ProductLearnMoreCard
            ...
            href="https://docs.web3sdk.io/gamingkit"
          />
          <ProductLearnMoreCard
            title="Manage"
            ...
            href="https://docs.web3sdk.io/dashboard"
          />
        </SimpleGrid>
      </ProductSection>
      ...
      <GuidesShowcase
        ...
        description="Check out our guides and case studies to start building games with web3sdkio"
        solution="Gaming"

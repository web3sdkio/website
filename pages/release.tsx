...
const RELEASE_GUIDES = [
  {
    title: "Introducing web3sdkio Release",
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/09/Blog-thumbnail_tw-release.png",
    link: "https://blog.web3sdk.io/web3sdkio-release/",
  },
  {
    title: "Register Your Contracts Using Release",
    image:
      "https://blog.web3sdk.io/content/images/size/w2000/2022/09/register-your-smart-contracts-using-web3sdkio-release.png",
    link: "https://blog.web3sdk.io/guides/register-your-contract-using-web3sdkio-release/",
  },
];

const Release: Web3sdkioNextPage = () => {
  return (
    <ProductPage
      seo={{
        title: "Release",
        ...
        <Flex direction="column" gap={24}>
          ...
          >
            ...
            >
              ...
              unlock access to web3sdkio tools that makes it easier to build on

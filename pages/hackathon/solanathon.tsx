...
const SolanaHackathon: Web3sdkioNextPage = () => {
  const trackEvent = useTrack();
  return (
    <DarkMode>
      <NextSeo
        title="web3sdkio Solanathon: October 19 - 26 | Build web3 apps, win $10,000"
        description="Join web3sdkio's first-ever official hackathon! Solanathon is a 7-day event with $10,000 in prizes for inspiring web3 builders on Solana. Learn more."
        openGraph={{
          title:
            "web3sdkio Solanathon: October 19 - 26 | Build web3 apps, win $10,000",
          url: "https://web3sdk.io/hackathon/solanathon",
          description:
            "Join web3sdkio's first-ever official hackathon! Solanathon is a 7-day event with $10,000 in prizes for inspiring web3 builders on Solana. Learn more.",
          images: [
            {
              url: "https://web3sdk.io/assets/og-image/solanathon.jpg",
              width: 1200,
              height: 630,
              alt: "web3sdkio Solanathon: October 19 - 26",
            },
          ],
        }}
      />
          ...
          <Flex flexDir="column" alignItems="center" gap={8}>
            ...
            <Flex flexDir="column" gap={4}>
              ...
              <Text size="body.lg">
                <List>
                  <ListItem>
                    - Use a web3sdkio prebuilt program or an existing program on
                    Solana and interface with the web3sdkio SDKs
                  </ListItem>
